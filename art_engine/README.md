...
Go to the root of your folder and run this command if you have pnpm installed.
...
Once you have all your layers, go into `src/config.js` and update the `layerConfigurations` objects `layersOrder` array to be your layer folders name in order of the back layer to the fromt layer.
...
const layerConfigurations = [
  {
    ...
    layersOrder: [{ name: 'Head' }, { name: 'Mouth' }, { name: 'Eyes' }, { name: 'Eyeswear' }, { name: 'Headwear' }],
  },
];
```
